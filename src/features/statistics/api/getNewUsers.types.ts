...
export function useNewUsersStatisticsQuery(
  baseOptions: Apollo.QueryHookOptions<NewUsersStatisticsQuery, NewUsersStatisticsQueryVariables> &
    ({ variables: NewUsersStatisticsQueryVariables; skip?: boolean } | { skip: boolean })
) {
...
export function useNewUsersStatisticsSuspenseQuery(
  ...
  const options = { ...defaultOptions, ...baseOptions }
  return Apollo.useSuspenseQuery<NewUsersStatisticsQuery, NewUsersStatisticsQueryVariables>(
    NewUsersStatisticsDocument,
    options
  )
}
...
>
export type NewUsersStatisticsSuspenseQueryHookResult = ReturnType<
  typeof useNewUsersStatisticsSuspenseQuery
>
